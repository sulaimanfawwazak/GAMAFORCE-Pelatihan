...
"""autogenerated by genpy from gmfc/coordinate.msg. Do not edit."""
import codecs
import sys
...
class coordinate(genpy.Message):
  _md5sum = "36ac278e1f13c9951d4d6498c308eba5"
  _type = "gmfc/coordinate"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string message
float32 latitude
float32 longitude
"""
  __slots__ = ['message','latitude','longitude']
